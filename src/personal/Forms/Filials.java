...
public class Filials extends JFrame {
    ...
    private void createMenu() {
        ...
        PopupMenuListener menuListen = new PopupMenuListener("Филиалы");
    ...
    private void addFilialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addFilialActionPerformed
        String result = JOptionPane.showInputDialog("Введите название филиала");

        if ((result == null) || (result.length() == 0)) {
            JOptionPane.showMessageDialog(this, "Филиал не был добавлен");
        } else {
            filialModel.Add(result);
            JOptionPane.showMessageDialog(this, "Новый филиал добавлен");
        }
