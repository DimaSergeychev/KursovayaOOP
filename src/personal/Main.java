...
public class Main extends javax.swing.JFrame {
    ...
    private void createRBMenu() {
        ...
        PopupMenuListener menuListen = new PopupMenuListener("Работники");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Сотрудники");

        addEmpl.setText("Добавить сотрудника");
        ...
        menuFilial.setText("Филиалы");

        filialItem.setText("Филиалы");
        ...
        position.setText("Должности");

        menuPosition.setText("Должности");
        ...
        searchItem.setText("Поиск сотрудника");
    ...
    private void searchItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchItemActionPerformed
        String result = JOptionPane.showInputDialog("Введите фио сотрудника");
        ArrayList<Employee> foundEmployee = new ArrayList();
        if (result !=null && result.length() >0){
            for (Employee employee: dataBase.getEmployee()){
                if (employee.getFio().equalsIgnoreCase(result) || employee.getFio().toLowerCase().contains(result.toLowerCase())){
                    foundEmployee.add(employee);
                }
            }
            new FoundEmployee(foundEmployee).setVisible(true);
        }
